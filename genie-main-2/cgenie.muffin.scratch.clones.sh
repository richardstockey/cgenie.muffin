...
for clone in $(seq $2)
do
[ -d "/scratch/$USER/cgenie.muffins/cgenie.muffin/genie-main-$clone" ] && rm -r /scratch/$USER/cgenie.muffins/cgenie.muffin/genie-main-$clone
svn checkout https://github.com/$1/cgenie.muffin/trunk/genie-main /scratch/$USER/cgenie.muffins/cgenie.muffin/genie-main-$clone
