...
%
par_wor_name='L23z_314';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfKsl_314';             % ['STRING'] input experiment/data name
par_age=314.6;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.314_adjusted'; % ['STRING'] optional mask adjustment name
%
% *** INPUT + OUTPUT SETTINGS ******************************************* %
%
par_pathin='/Users/rgs1e22/LuntScotese2023_HADCM3';   % ['STRING'] path to input dir
par_pathout='HADCM3L_16lvl_z_adjusted'; % ['STRING'] path to output dir
