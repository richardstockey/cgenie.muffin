...
%
par_wor_name='L23z_520';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tFksa_520';             % ['STRING'] input experiment/data name
par_age=520.0;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.520_adjusted'; % ['STRING'] optional mask adjustment name
%
