...
%
par_wor_name='L23z_380';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfKsy_380';             % ['STRING'] input experiment/data name
par_age=380.0;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.380_adjusted'; % ['STRING'] optional mask adjustment name
%
