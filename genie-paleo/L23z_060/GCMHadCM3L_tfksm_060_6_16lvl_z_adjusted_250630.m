...
%
par_wor_name='L23z_060';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfksm_060';             % ['STRING'] input experiment/data name
par_age=060.6;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.060_adjusted'; % ['STRING'] optional mask adjustment name
%
