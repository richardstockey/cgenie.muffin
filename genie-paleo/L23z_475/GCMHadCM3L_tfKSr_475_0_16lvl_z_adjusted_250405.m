...
%
par_wor_name='L23z_475';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfKSr_475';             % ['STRING'] input experiment/data name
par_age=475.0;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.475_adjusted'; % ['STRING'] optional mask adjustment name
%
