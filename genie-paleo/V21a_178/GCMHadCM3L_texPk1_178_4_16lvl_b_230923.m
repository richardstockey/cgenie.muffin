...
%
par_wor_name='V21a_178';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='texPk1_178';             % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
par_pathin='Valdes2021';   % ['STRING'] path to input dir
par_pathout='HADCM3L_16lvl_b'; % ['STRING'] path to output dir
