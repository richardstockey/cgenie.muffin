...
%
par_wor_name='L23z_039';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfksi_039';             % ['STRING'] input experiment/data name
par_age=039.5;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.039_adjusted'; % ['STRING'] optional mask adjustment name
%
