...
%
par_wor_name='L23j_204';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfkSp_204';             % ['STRING'] input experiment/data name
par_age=204.9;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.204_adjusted'; % ['STRING'] optional mask adjustment name
%
