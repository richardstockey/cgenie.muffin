...
%
par_wor_name='460tc12_';       % ['STRING'] 8-char (output) config name
...
%
par_nc_topo_name  = 'Topobathy_460tc_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_mask_name  = 'Topobathy_460tc_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_axes_name  = 'Topobathy_460tc_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_atmos_name = '460tc_1316.46W_EccN_atmos_3360ppm';        % ['STRING'] optional .nc name
par_nc_ocean_name = '460tc_1316.46W_EccN_coupl_3360ppm';        % ['STRING'] optional .nc name
par_nc_coupl_name = '460tc_1316.46W_EccN_coupl_3360ppm';        % ['STRING'] optional .nc name
%
% *** GRID RESOLUTION *************************************************** %
%
