...
%
par_wor_name='L23j_044';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfksj_044';             % ['STRING'] input experiment/data name
par_age=044.5;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.044_adjusted'; % ['STRING'] optional mask adjustment name
%
