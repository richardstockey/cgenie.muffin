...
%
par_wor_name='L23j_145';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfkSd_145';             % ['STRING'] input experiment/data name
par_age=145.0;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.145_adjusted'; % ['STRING'] optional mask adjustment name
%
