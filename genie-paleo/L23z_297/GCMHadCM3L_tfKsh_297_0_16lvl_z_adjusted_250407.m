...
%
par_wor_name='L23z_297';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfKsh_297';             % ['STRING'] input experiment/data name
par_age=297.0;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.297_adjusted'; % ['STRING'] optional mask adjustment name
%
