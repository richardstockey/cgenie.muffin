...
%
par_wor_name='L23j_252';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfkSy_252';             % ['STRING'] input experiment/data name
par_age=252.0;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.252_adjusted'; % ['STRING'] optional mask adjustment name
%
