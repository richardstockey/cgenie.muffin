...
%
par_wor_name='L23z_455';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfKSn_455';             % ['STRING'] input experiment/data name
par_age=455.7;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.455_adjusted'; % ['STRING'] optional mask adjustment name
%
