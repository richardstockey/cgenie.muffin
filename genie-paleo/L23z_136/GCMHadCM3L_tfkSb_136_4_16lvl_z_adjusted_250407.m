...
%
par_wor_name='L23z_136';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfkSb_136';             % ['STRING'] input experiment/data name
par_age=136.4;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.136_adjusted'; % ['STRING'] optional mask adjustment name
%
