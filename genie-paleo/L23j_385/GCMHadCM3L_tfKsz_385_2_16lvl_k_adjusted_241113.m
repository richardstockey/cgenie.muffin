...
%
par_wor_name='L23j_385';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfKsz_385';             % ['STRING'] input experiment/data name
par_age=385.2;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.385_adjusted'; % ['STRING'] optional mask adjustment name
%
