...
%
par_wor_name='L23j_305';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfKsj_305';             % ['STRING'] input experiment/data name
par_age=305.4;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.305_adjusted'; % ['STRING'] optional mask adjustment name
%
