...
%
par_wor_name='L23j_395';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfKSb_395';             % ['STRING'] input experiment/data name
par_age=395.0;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.395_adjusted'; % ['STRING'] optional mask adjustment name
%
