...
%
par_wor_name='L23z_168';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfkSi_168';             % ['STRING'] input experiment/data name
par_age=168.2;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.168_adjusted'; % ['STRING'] optional mask adjustment name
%
