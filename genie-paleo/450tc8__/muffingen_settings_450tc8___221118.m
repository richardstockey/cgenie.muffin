...
%
par_wor_name='450tc8__';       % ['STRING'] 8-char (output) config name
par_gcm='foam';                  % ['STRING'] input format/GCM name
par_expid='ordotc';            % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
...
%
par_nc_topo_name  = 'Topobathy_450tc_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_mask_name  = 'Topobathy_450tc_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_axes_name  = 'Topobathy_450tc_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_atmos_name = '450tc_1317.54W_EccN_atmos_2240ppm';        % ['STRING'] optional .nc name
par_nc_ocean_name = '450tc_1317.54W_EccN_coupl_2240ppm';        % ['STRING'] optional .nc name
par_nc_coupl_name = '450tc_1317.54W_EccN_coupl_2240ppm';        % ['STRING'] optional .nc name
%
% *** GRID RESOLUTION *************************************************** %
%
...
par_tauopt=0;                  % [0/1/2/3] zonal windstress option [grey world]
par_age=450.0;                 % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
