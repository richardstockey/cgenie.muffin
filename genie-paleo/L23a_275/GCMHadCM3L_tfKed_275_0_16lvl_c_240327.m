...
%
par_wor_name='L23a_275';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfKed_275';             % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
par_pathin='/Users/rgs1e22/Lunt2023_HADCM3';   % ['STRING'] path to input dir
par_pathout='HADCM3L_16lvl_c'; % ['STRING'] path to output dir
...
opt_equalarea=true;            % [false/true]hadcm3 equal area grid?
%
% *** REGRIDDING SETTINGS *********************************************** %
%
...
par_age=275.0;                   % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
