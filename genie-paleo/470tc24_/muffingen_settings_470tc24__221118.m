...
%
par_wor_name='470tc24_';       % ['STRING'] 8-char (output) config name
...
%
par_nc_topo_name  = 'Topobathy_470tc_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_mask_name  = 'Topobathy_470tc_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_axes_name  = 'Topobathy_470tc_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_atmos_name = '470tc_1315.38W_EccN_atmos_6720ppm';        % ['STRING'] optional .nc name
par_nc_ocean_name = '470tc_1315.38W_EccN_coupl_6720ppm';        % ['STRING'] optional .nc name
par_nc_coupl_name = '470tc_1315.38W_EccN_coupl_6720ppm';        % ['STRING'] optional .nc name
%
% *** GRID RESOLUTION *************************************************** %
%
...
par_age=470.0;                 % [0.0-4570.0] optional age (Myr)
%
% *** OPTIONS -- MAIN *************************************************** %
%
