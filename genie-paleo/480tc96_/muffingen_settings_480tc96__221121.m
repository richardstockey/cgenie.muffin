...
%
par_wor_name='480tc96_';       % ['STRING'] 8-char (output) config name
...
%
par_nc_topo_name  = 'Topobathy_480tc_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_mask_name  = 'Topobathy_480tc_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_axes_name  = 'Topobathy_480tc_postslarti_cor';        % ['STRING'] optional .nc name
par_nc_atmos_name = '480tc_1314.31W_EccN_atmos_26880ppm';        % ['STRING'] optional .nc name
par_nc_ocean_name = '480tc_1314.31W_EccN_coupl_26880ppm';        % ['STRING'] optional .nc name
par_nc_coupl_name = '480tc_1314.31W_EccN_coupl_26880ppm';        % ['STRING'] optional .nc name
%
% *** GRID RESOLUTION *************************************************** %
%
