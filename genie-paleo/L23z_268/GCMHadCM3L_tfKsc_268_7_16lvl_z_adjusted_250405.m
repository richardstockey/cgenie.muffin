...
%
par_wor_name='L23z_268';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfKsc_268';             % ['STRING'] input experiment/data name
par_age=268.7;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.268_adjusted'; % ['STRING'] optional mask adjustment name
%
