...
%
par_wor_name='L23z_498';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tfKSw_498';             % ['STRING'] input experiment/data name
par_age=498.8;                   % [0.0-4570.0] optional age (Myr)
par_mask_name='mask.498_adjusted'; % ['STRING'] optional mask adjustment name
%
